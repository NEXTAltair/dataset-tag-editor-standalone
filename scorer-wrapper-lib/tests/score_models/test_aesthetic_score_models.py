...
from scorer_wrapper_lib.score_models.aesthetic_shadow import AestheticShadowV1, AestheticShadowV2
from scorer_wrapper_lib.score_models.cafe_aesthetic import CafePredictor

# 絶対パスを使用してfeatureファイルを参照
# NOTE: pyproject.tomlの bdd_features_base_dir 設定があるのでこれは本来不要だが、
...
def model_context() -> dict[str, Any]:
    ...
    # NOTE: スコアの桁数は減らしている
    output_formats = {
        "aesthetic_shadow": [{"label": "hq", "score": 0.65}, {"label": "lq", "score": 0.35}],
        "cafe_aesthetic": [
